           ...
           <div className="lg:col-span-2">
              <Link to="/" className="mb-6 inline-block">
                <img 
                  ...
                  alt="Alanxa" 
                  className="h-8 max-w-[150px] object-contain brightness-0 invert" 
                />
              </Link>
              ...
              <div className="flex space-x-4">
                  <a href="https://www.linkedin.com/company/alanxa" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-blue-600 transition-colors text-gray-400 hover:text-white">
                      <LinkedinIcon className="w-5 h-5" />
                  </a>
                  <a href="https://x.com/alanxa_ai" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-black transition-colors text-gray-400 hover:text-white">
                      <TwitterIcon className="w-5 h-5" />
                  </a>
                  <a href="https://www.instagram.com/alanxa.ai/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-pink-600 transition-colors text-gray-400 hover:text-white">
                      <InstagramIcon className="w-5 h-5" />
                  </a>
                  <a href="https://www.facebook.com/alanxa.ai" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-blue-700 transition-colors text-gray-400 hover:text-white">
                      <FacebookIcon className="w-5 h-5" />
                  </a>
                  <a href="https://www.threads.net/@alanxa.ai" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors text-gray-400 hover:text-white">
