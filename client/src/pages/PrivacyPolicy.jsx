        ...
        <div className="bg-[#0A0F1C] rounded-3xl shadow-2xl border border-gray-800 p-8 md:p-12 space-y-10">
            ...
            <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                    <EyeIcon className="w-6 h-6 text-gray-500" /> 1. Information We Collect
                </h2>
            ...
            <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                    <LockIcon className="w-6 h-6 text-gray-500" /> 2. How We Use Your Data
                </h2>
                <p className="text-gray-300 leading-relaxed text-base">
                    We use the information we collect for the following purposes:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-gray-300 mt-4 text-base">
            ...
            <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
                    <FileTextIcon className="w-6 h-6 text-gray-500" /> 3. Data Protection
                </h2>
                <p className="text-gray-300 leading-relaxed text-base">
