    ...
    <div className="bg-black min-h-screen text-white" style={{ scrollBehavior: 'smooth' }}>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden bg-[#0A0F1C] text-white">
        ...
        <div className="absolute inset-0 z-0">
            <img 
               src="https://res.cloudinary.com/dikppmyhp/image/upload/v1766045166/0.37_seconds_Careers_backround_ueh07k.jpg" 
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-4">
          <motion.span 
            ...
            className="inline-block py-1 px-3 rounded-full bg-white/5 border border-white/10 text-indigo-300 text-sm font-semibold tracking-wider mb-4"
          >
            OUR DNA
          </motion.span>
          <motion.h1 
      ...
      <section className="py-16 bg-[#0A0F1C] border-y border-gray-800 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 mb-10 flex justify-between items-end">
          ...
          <button className="text-indigo-400 text-sm font-semibold hover:text-indigo-300 transition-colors">Instagram &rarr;</button>
        </div>
